...
import endRegulation from './_lib/match-handlers/end-regulation'
import finalizePk from './_lib/match-handlers/finalize-pk'
import finalizeReview from './_lib/match-handlers/finalize-review'
import logCard from './_lib/match-handlers/log-card'
import logFormation from './_lib/match-handlers/log-formation'
import logGoal from './_lib/match-handlers/log-goal'
import logPeriod from './_lib/match-handlers/log-period'
import logPkAttempt from './_lib/match-handlers/log-pk-attempt'
import logSubstitution from './_lib/match-handlers/log-substitution'
import logTeamEvent from './_lib/match-handlers/log-team-event'
import removeLastGoal from './_lib/match-handlers/remove-last-goal'
