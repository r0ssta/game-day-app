/**
 * Single source of truth for match orchestration Zod schemas.
 * Kept under api/_lib so Vercel Node handlers do not depend on Vite path aliases.
 * The Vite app re-exports this module from src/schemas/match-actions.ts.
 */
import { z } from 'zod'
