-- Personal goal/assist bonus on WPI Offense.
-- Team on-pitch goals stay as plus-minus. Scorer gets +2 extra, assister +1.
-- Assists come from goal.assist_player_id plus legacy assist events.
  ...
  match_weighted as (
    select
      ...
      (
        ...
        + mw.team_shots
        + mw.team_corners
        -- WPI_GOAL_BONUS = 2, WPI_ASSIST_BONUS = 1 (offense only)
        + 2 * mw.player_goals
        + mw.player_assists
