-- Include on-pitch goal +/- in WPI alongside shots and corners.
-- Our goals count +, opponent goals count −. Field-player only
-- (GK stints stay on the GK GA column, not WPI).
...
begin
  ...
  match_weighted as (
    select
      ...
      (
        (
          (mfs.team_goals - mfs.opponent_goals)
