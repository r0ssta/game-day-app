-- Scoreline-aware personal G/A bonus on WPI Offense.
-- On-pitch plus-minus is unchanged. Personal bonus is (2G + A) * sqrt(3 / T)
-- where T is match team goals (goal events, else home_score), then opponent
-- strength and coach rating. Assists: goal.assist_player_id plus legacy assist.
