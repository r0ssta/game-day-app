-- Count on-pitch corners in player impact the same way as shots:
-- corner_home is positive, corner_away is negative. Field-player only
-- (GK stints excluded). WPI weights net shots + net corners together.
    ...
    select
      ...
      (
        (
          ...
          + (mfs.team_corners - mfs.opponent_corners)
        )
