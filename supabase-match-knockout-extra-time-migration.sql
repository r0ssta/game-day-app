-- Knockout tournament flag, extra-time / PK in-progress statuses, and Parent Hub
-- streaming after regulation (including pk_attempt rows).

alter table public.matches
  add column if not exists is_tournament_knockout boolean;
...
drop policy if exists "matches_select_parent_in_progress" on public.matches;
create policy "matches_select_parent_in_progress"
